...
def process_gridworld_data(input, imsize):
    ...
    all_training_samples = int(19/20.0*Xdata.shape[0])
    #set the size of training data
    training_samples = int(4000.0)
...
#process_gridworld_data('data/gridworld_16.mat',16)
#process_gridworld_data('data/a4_gridworld_8.mat',8)
